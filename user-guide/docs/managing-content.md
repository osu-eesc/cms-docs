...
| ------ | ------ | ----- |
| **Educational content** | Edit the content and **add a tag for the topic in Step 2 of the edit screen**. If you want the content to show on the topic landing page, a member of the topic committee will need to select it in a “**featured topic section**.” | Select the content in a “**featured topic section**” on the landing page. You will need to be a member of the topic committee for that topic. </br>Or </br>**Contact the person** who added the content and ask them to tag it with the topic. See [Working with Other Content Authors](managing-content.md#working-with-other-content-authors) for more information. |
...
| **Events & Announcements** | Enter the content through the program’s group <br>Or<br> Edit the content and add a tag for the program. Someone associated with the program will need to add a “Program events list” section to the page where you want the content to show.  | **Contact the person** who added the content and ask them to tag it with the program. See [Working with Other Content Authors](managing-content.md#working-with-other-content-authors) for more information. </br></br>Someone associated with the program will need to add a “**Program events list**” section to the page where you want the content to show. |
| **People** | Submit a [web support request](https://osueesc.atlassian.net/servicedesk/customer/portal/2) to have a person added to the directory for a program. | |
